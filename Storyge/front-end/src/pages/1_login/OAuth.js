...
const KAKAO_REDIRECT_URI = `http://${LOCAL_URL}/oauth/callback/kakao`;
...
const NAVER_REDIRECT_URI = `http://${LOCAL_URL}/oauth/callback/naver`;
...
const GOOGLE_REDIRECT_URI = `http://${LOCAL_URL}/oauth/callback/google`;
